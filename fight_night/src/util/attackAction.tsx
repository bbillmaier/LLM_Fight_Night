  ...
  if (who === "player") {
    ...
    if (hit === true) {
      if(playerDefeatsMonster === true){
        //forgot about how Reacts short hand uses ` and got frustrated and just did it the long way. Will refactor all of this at some point anyway. I have some idea about how to make a prompt building component elsewhere in the app to give more player control anyway.
        prompt = props.player.name + " attacked " + props.monster.name + " with their " + props.player.charWeapon + " and successfully struck them for " + String(damageDealt) + ". This was a killing blow and  " + props.monster.name + " has been slain! Please describe the attack. note: " + playerDescriptionPrompt + " and " + monsterDescriptionPrompt;
      }else{
        prompt = props.player.name + " attacked " + props.monster.name + " with their " + props.player.charWeapon + " and successfully struck them for " + String(damageDealt) + ". Please describe the attack. Note: " + props.monster.name + " survives the attack.  note: " + playerDescriptionPrompt + " and " + monsterDescriptionPrompt;
      }
    } else {
      prompt = props.player.name + " attacked " + props.monster.name + " with their " + props.player.charWeapon + " and missed. Please describe the attempt. note: " + playerDescriptionPrompt + " and " + monsterDescriptionPrompt;
    }
    ...
    if (hit2 === true) {
        if(monsterDefeatsPlayer === true){
            prompt2 = props.monster.name + " attacked " + props.player.name + " with their " + props.monster.charWeapon + " and successfully struck them for " + String(damageDealt2) + ". This was a killing blow and " + props.player.name + " has been slain! note: " + playerDescriptionPrompt + " and " + monsterDescriptionPrompt;
        }else{
            prompt2 = props.monster.name + " attacked " + props.player.name + " with their " + props.monster.charWeapon + " and successfully struck them for " + String(damageDealt2) + ". Please describe the attack. Note: " + props.player.name + " survives the attack. note: " + playerDescriptionPrompt + " and " + monsterDescriptionPrompt;
        }
    } else {
        prompt2 = props.monster.name + " attacked " + props.player.name + " with their " + props.monster.charWeapon + " and missed. Please describe the attempt. note: " + playerDescriptionPrompt + " and " + monsterDescriptionPrompt;
    }
